<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:79:"C:\phpEnv\www\localhost\zhihui\public/../application/user\view\index\index.html";i:1554791438;s:69:"C:\phpEnv\www\localhost\zhihui\application\user\view\layout\meta.html";i:1554791438;s:71:"C:\phpEnv\www\localhost\zhihui\application\user\view\layout\header.html";i:1554791438;s:69:"C:\phpEnv\www\localhost\zhihui\application\user\view\layout\menu.html";i:1554791438;s:72:"C:\phpEnv\www\localhost\zhihui\application\user\view\layout\control.html";i:1554791438;s:71:"C:\phpEnv\www\localhost\zhihui\application\user\view\layout\script.html";i:1554791438;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo $user['avatar']; ?>" class="user-image" alt="<?php echo $user['nickname']; ?>">
                        <span class="hidden-xs"><?php echo $user['nickname']; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="<?php echo $user['avatar']; ?>" class="img-circle" alt="">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo url('user/user/profile'); ?>" class="btn btn-primary addtabsit"><i class="fa fa-user"></i>
                                    <?php echo __('Profile'); ?></a>
                            </div>
                            <div class="pull-right">
                                <a href="<?php echo url('user/index/logout'); ?>" class="btn btn-danger"><i class="fa fa-sign-out"></i>
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="user/profile" class="addtabsit"><img src="<?php echo $user['avatar']; ?>" class="img-circle" /></a>
        </div>
